...
function mostrarListaTareas(tareas, rl, volverAlMenu) {
    ...
    rl.question("Elegí una tarea: ", (opcion) => {
        ...
        mostrarDetallesTarea(tareaSeleccionada, rl, volverAlMenu);
    });
}


function mostrarDetallesTarea(tarea, rl, volverAlMenu) {
    ...
    console.log("Fecha de finalización: " + tarea.fechaFinalizacion);
    ...
    rl.question("Elegí una opción: ", (opcion) => {
        ...
        console.log("Opción inválida.");
        mostrarDetallesTarea(tarea, rl, volverAlMenu);
    });
}
